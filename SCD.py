...
#        print("*"*5+message+"*"*5)
    ...
    def detect_communities(self,verbose=False,sparisfy=True,parallel_step=6,prob_threshold=0.0005, community_range = "auto", num_important=100,clustering_measure="incluster_distance",stopping=5,improvement_step=0.05,node_feature_type = "netmf_embedding", negative_range = [1], window_sizes = [3], dims = [64],output_format = "nongrouped", use_normalized_scores=True):
